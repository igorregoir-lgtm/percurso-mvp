...
Saída da última execução: [`EVIDENCIAS-DE-TESTE.txt`](EVIDENCIAS-DE-TESTE.txt) — **471 passaram,
0 falharam**.

Há também uma bateria de **192 testes unitários** das regras críticas de domínio (filtro de
