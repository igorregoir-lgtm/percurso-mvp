...
Há também uma bateria de **110 testes unitários** das regras críticas de domínio (filtro de
...
Os testes unitários somam **110** (os 55 originais + escopo de turma, aviso de corte da lista,
