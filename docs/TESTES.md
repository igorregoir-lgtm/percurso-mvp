...
Há também uma bateria de **106 testes unitários** das regras críticas de domínio (filtro de
...
Os testes unitários somam **106** (os 55 originais + escopo de turma, aviso de corte da lista,
