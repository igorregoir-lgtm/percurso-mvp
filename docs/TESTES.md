...
Saída da última execução: [`EVIDENCIAS-DE-TESTE.txt`](EVIDENCIAS-DE-TESTE.txt) — **403 passaram,
0 falharam**.

Há também uma bateria de **176 testes unitários** das regras críticas de domínio (filtro de
