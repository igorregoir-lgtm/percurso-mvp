...
Há também uma bateria de **156 testes unitários** das regras críticas de domínio (filtro de
...
Os testes unitários somam **156** (pós-visita: invariantes da Vivência, rubrica e planilha, catálogos e extração do check-in, perímetro com contexto em pares, relato e liberação, devolução, régua e recado, parecer; antes disso, **115** (os 55 originais + escopo de turma, aviso de corte da lista,
