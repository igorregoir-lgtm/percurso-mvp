...
Saída da última execução: [`EVIDENCIAS-DE-TESTE.txt`](EVIDENCIAS-DE-TESTE.txt) — **489 passaram,
0 falharam**.

Há também uma bateria de **199 testes unitários** das regras críticas de domínio (filtro de
