...
deste documento — nem por nenhum dos 205 testes unitários ou das 504 asserções de fluxo do
repositório.
...
(`public/app.js:6291`); desde 04/09/2026 o relato **abre sozinho** na Vivência, logo depois de confirmar a folha. O limiar de 20 s existe para separar "ela não
