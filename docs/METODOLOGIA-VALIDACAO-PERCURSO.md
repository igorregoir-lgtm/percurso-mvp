...
deste documento — nem por nenhum dos 199 testes unitários ou das 489 asserções de fluxo do
repositório.
...
(`public/app.js:5958`); desde 04/09/2026 o relato **abre sozinho** na Vivência, logo depois de confirmar a folha. O limiar de 20 s existe para separar "ela não
