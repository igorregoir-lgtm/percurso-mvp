...
deste documento — nem por nenhum dos 170 testes unitários ou das 385 asserções de fluxo do
repositório.
...
(`public/app.js:4553`); o relato não se abre sozinho. O limiar de 20 s existe para separar "ela não
