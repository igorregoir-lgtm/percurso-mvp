...
> 422 para a turma dela, por construção (`src/api.js:347`). Não dava para trocar a persona e manter
...
O motivo é simples. O MVP tem 407 asserções de fluxo e 177 testes unitários — mas teste
...
> isso a ela (`public/app.js:1263`). O sucesso da tarefa é ela entender **por que não sai**, não
