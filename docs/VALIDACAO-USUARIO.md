...
> 422 para a turma dela, por construção (`src/api.js:323`). Não dava para trocar a persona e manter
...
> psicóloga não pode registrar o consentimento — só a coordenação (`src/api.js:449`), e a tela diz
