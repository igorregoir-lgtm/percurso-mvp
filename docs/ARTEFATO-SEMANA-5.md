...
| 3 | User Stories (3 a 5) | ✅ | §3 — as seis, com a tela e o teste que prova cada uma |
...
## 3. User Stories — as seis, com a prova de cada uma
...
(protocolo da sessão), [`EVIDENCIAS-DE-TESTE.txt`](EVIDENCIAS-DE-TESTE.txt) (saída das 512
