...
scripts/         reset.mjs · smoke-test.mjs (407 asserções) · unit-test.mjs (177) · preparar-sessao.mjs
...
| ~~1.2~~ | ~~**Escopo de turma no RBAC**~~ **FEITO 25/08** (decisão 22) | O acesso declarado na governança é "educador da criança + coordenação"; a v2 fechou a diretoria (decisão 16) e a v3 fechou o escopo entre educadoras | Rotas de leitura individual filtram por turma do educador logado; smoke bloco 12 cobre o acesso negado (407) |
