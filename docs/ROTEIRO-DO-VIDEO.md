...
4. **Cena 9 (recado):** abrir pelo botão **"Recado para os responsáveis"** no cartão da folha, na
   ...
   (`public/app.js:640`). Até ali ele sumia em dia não letivo e a cena tinha de abrir `#/sai-daqui?aba=recado`
...
```
node scripts/smoke-test.mjs   → 517 passaram · 0 falharam
node scripts/unit-test.mjs    → 221 passaram · 0 falharam
```
