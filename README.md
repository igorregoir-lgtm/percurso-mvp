...
São **397 asserções de fluxo** e **175 testes unitários** — mais a avaliação do RAG
...
src/db.js                 esquema do banco (26 tabelas) e helpers de SQL
...
scripts/smoke-test.mjs    397 asserções do fluxo principal (contra o servidor no ar)
scripts/unit-test.mjs     175 testes unitários das regras críticas (banco temporário)
