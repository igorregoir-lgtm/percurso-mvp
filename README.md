...
São **255 asserções de fluxo** e **106 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     106 testes unitários das regras críticas (banco temporário)
