...
São **255 asserções de fluxo** e **98 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     98 testes unitários das regras críticas (banco temporário)
