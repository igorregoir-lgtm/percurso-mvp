...
São **255 asserções de fluxo** e **81 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     81 testes unitários das regras críticas (banco temporário)
