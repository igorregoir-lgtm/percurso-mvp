...
scripts/smoke-test.mjs    365 asserções do fluxo principal (contra o servidor no ar)
scripts/unit-test.mjs     159 testes unitários das regras críticas (banco temporário)
