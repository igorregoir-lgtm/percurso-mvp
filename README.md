...
São **368 asserções de fluxo** e **163 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     163 testes unitários das regras críticas (banco temporário)
