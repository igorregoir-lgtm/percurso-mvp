...
São **255 asserções de fluxo** e **109 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     109 testes unitários das regras críticas (banco temporário)
