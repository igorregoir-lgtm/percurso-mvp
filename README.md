...
São **255 asserções de fluxo** e **110 testes unitários** — mais a avaliação do RAG
...
scripts/unit-test.mjs     110 testes unitários das regras críticas (banco temporário)
