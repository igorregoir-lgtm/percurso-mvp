...
// não de organização: o orquestrador da Aurora (src/aurora/orquestrador.js) é o
...
//
// TODA chamada ao modelo passa por aqui — copilot, extrator, SROI, Aurora. O
 ...
 *      painel da Aurora, que só melhora rótulos de um painel JÁ pintado —
