...
test('as citações arquivo:linha da documentação apontam para o que prometem', async () => {
  ...
  const ANCORAS = {
    'public/app.js:513': /rota\(\/\^#\\\/hoje\//,
    'public/app.js:610': /Revisar e liberar o relato|relato_liberado/,
    ...
    'public/app.js:611': /data-acao="ir" data-href="#\/sai-daqui\?aba=recado&turma_id=\$\{r\.turma_id\}&data=\$\{r\.data\}"/,
    'public/app.js:1444': /coordenacao.*Consentimentos|Registre abaixo/,
    // A rota #/scores virou aba do Painel (F2); a âncora segue o conteúdo.
    'public/app.js:3340': /async function telaScores\(\)/,
    'public/app.js:3574': /id="pergunta"/,
    ...
    'public/app.js:6297': /location\.hash = vaiParaORelato \? `#\/sai-daqui\?aba=relato/,
    'src/api.js:388': /erro\(422.*rubrica por ciclo/,
    'src/api.js:829': /'POST \/api\/consentimento'/,
    'src/api.js:1342': /periodosSugeridos\(\)/,
